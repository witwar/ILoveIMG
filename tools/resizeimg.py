...
class ResizeByPercentageIMG(ILoveIMG):
    def __init__(self, public_key):
        super().__init__(public_key)

    async def run(self, input_file: str, output_file: str, percentage: int):
        self.input_file = input_file
        self.output_file = output_file
        self.params = {'resize_mode': 'percentage',  'percentage': percentage}
        self.tool = 'resizeimage'
